...
Manage your HostAfrica VPS, DNS and domains by asking your AI assistant. This extension registers the HostAfrica [remote MCP server](https://modelcontextprotocol.io/) with VS Code natively, and with every other AI tool on your machine if you want.
